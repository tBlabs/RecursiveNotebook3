...
var AddNoteCommandHandler = (function () {
    ...
    AddNoteCommandHandler.prototype.Handle = function (command, context) {
                ...
                switch (_a.label) {
                    case 0:
                        if (!context.user.claims.canAddNote) {
                            throw new HandlerException_1.HandlerException(errors_1.Ex.NoPermissionToCreateNote);
                        }
...
exports.AddNoteCommandHandler = AddNoteCommandHandler;
//# sourceMappingURL=AddNoteCommandHandler.js.map