...
var errors_2 = require("./shared/errors/errors");
...
var Startup = (function () {
    ...
    Startup.HandleCqrsBus = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var context, authorizationHeader, authService, user, result, ex_1, respondStatusCode, serializedException, exception, exception;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        serializedException = "Unhandled exception";
                        if (ex_1 instanceof HandlerException_1.HandlerException) {
                            console.log("Handler exception:", ex_1);
                            exception = errors_1.SERVER_EXCEPTIONS.find(function (x) { return x.code === ex_1.exCode; });
                            exception.extra = ex_1.extra;
                            serializedException = JSON.stringify(exception);
                            respondStatusCode = exception.code;
                        }
                        else if (ex_1 instanceof CqrsException_1.CqrsException) {
                            console.log("CQRS Engine exception:", ex_1);
                            exception = errors_1.SERVER_EXCEPTIONS.find(function (x) { return x.code === errors_2.Ex.CqrsException; });
                            exception.extra = ex_1.message;
                            serializedException = JSON.stringify(exception);
                            respondStatusCode = exception.code;
                        }
                        else {
                        ...
                        if (res)
                            res.status(respondStatusCode).send(serializedException);
                        return [3, 5];
                    case 5: return [2];
                }
            });
