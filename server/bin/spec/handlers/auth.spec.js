...
describe('LoginQueryHandler', function () {
    it('should fail on invalid input', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    loginQuery = new LoginQuery_1.LoginQuery();
                    loginQuery.email = 'mail_without_monkey';
                    loginQuery.password = 'xD';
                    loginQueryHandler = new LoginQueryHandler_1.LoginQueryHandler(null, null);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4, loginQueryHandler.Handle(loginQuery, null)];
                case 2:
                    _a.sent();
                    return [3, 4];
                case 3:
