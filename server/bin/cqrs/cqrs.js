...
var Cqrs = (function () {
    ...
    Cqrs.ResolveMessageHandler = function (name) {
        var n = Object.keys(this.messageHandlers).find(function (i) { return i === name; });
        if (n === undefined)
            throw "Could not find handler for message \"" + name + "\".";
        return inversify_config_1.container.get(this.messageHandlers[n]);
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    return [2, messageHandler.Handle(messageBody, context)];
                }
                catch (error) {
                    console.log("CQRS EXECUTE ERROR: ", error);
                    throw new HandlerException_1.HandlerException("Wrong message", 400);
                }
                return [2];
            });
        });
